...
/**
 * PDF to PNG Converter — QA Audit Suite
 * Built on the QA-Auditor framework: SEO QA · UX QA · Functionality QA.
 * URL: https://www.itspdf.com/pdf-to-png
 *
 * ───────────────────────────────────────────────────────────────────────────
...
const CONFIG = {
  ...
  path: '/pdf-to-png',
  toolName: 'PDF to PNG',
  title: 'PDF to PNG converter - extract pictures from a PDF',
  description:
    'Convert pdf to png images within seconds. Our pdf to png converter is free, fast, secure, and works on any web browser.',
  imageExt: 'png',
};
